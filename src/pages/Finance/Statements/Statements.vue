                ...
                <v-card-text class="pa-0">
                  ...
                  <template v-slot:items="props">
                    <tr :active="props.selected" @click="props.selected = !props.selected">
                      ...
                      <td v-if="session.user().role !== 'parent' && session.user().role !== 'child'" class="text-xs-center px-0"><router-link :to="'/summary/'+ props.item.drawee_human">{{props.item.customer_name}}</router-link></td>
                    </tr>
                  </template>
...
<script>
import Statements from './Statements.vm.js';
