      ...
      <v-layout row wrap>
        <v-toolbar class="elevation-0" color="transparent">
          ...
          >
            ...
            <v-tooltip right>
              <v-btn fab dark small hover color="indigo" slot="activator" to="/case-create">
          ...
          >
            ...
            <v-tooltip left>
              <v-btn fab dark small hover color="red darken-3" slot="activator">
                <v-icon>insert_drive_file</v-icon>
              </v-btn>
              <span>Edit Case Statuses</span>
            </v-tooltip>
            <v-tooltip left>
              <v-btn fab dark small color="red darken-4" slot="activator">
                <v-icon>file_copy</v-icon>
              </v-btn>
              <span>Edit Case Types</span>
            </v-tooltip>
            <v-tooltip left>
              <v-btn fab dark small color="red darken-4" slot="activator">
                <v-icon>file_copy</v-icon>
              </v-btn>
              <span>Edit Case Note Types</span>
            </v-tooltip>
          </v-speed-dial>
        </v-toolbar>
        ...
        <v-flex xs12>
          ...
          <v-container mx-0 px-0>
            <v-layout row wrap>
              ...
              <v-flex sm6 xs12>
                <box-chart
                  title="Cases Notes by Status"
                  sub-title="10%"
                  icon="trending_up"
                  :data="dataset.CaseNoteStatus"
                  :chart-color="[color.blue]"
                  type="pie"
                  ref="CaseNoteStatus"
                  :dark="$vuetify.dark"
              ...
              <v-flex sm6 xs12>
                <box-chart
                  title="Cases Notes by Type"
                  sub-title="10%"
                  icon="trending_up"
                  :data="dataset.CaseNoteType"
                  :chart-color="[color.blue]"
                  type="pie"
                  ref="CaseNoteType"
                  :dark="$vuetify.dark"
            ...
            <v-card-text class="body-1 search">
                ...
                <v-container fluid>
                  <v-layout wrap justify-space-between class="body-1">
                    ...
                    <template v-for="{ 
                      id, type, label, multiple, maxlength, minlength, swaggerProperty
