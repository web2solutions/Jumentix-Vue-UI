      ...
      >
        ...
        <td 
          ...
          <template v-else>
            ...
            >delete</v-icon> -->
            <v-tooltip top>
              <v-btn small icon class="mx-0 ml-3 mt-2" slot="activator" @click="editItem(props.index)">
                <v-icon small>edit</v-icon>
              </v-btn>
              <span>Edit {{ props.item.first_name + ' ' + props.index}}</span>
            </v-tooltip>
            ...
            <v-tooltip top>
              ...
              <span>Delete {{ props.item.first_name + ' ' + props.item.last_name}}</span>
            </v-tooltip>

            <v-tooltip top>
              <v-btn small icon class="mx-0 mt-2" slot="activator" :to="{ name: 'ContactDetails', params: { query: query, id: props.item._id }}">
