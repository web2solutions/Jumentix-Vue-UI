            ...
            <v-card>
                ...
                <v-stepper v-model="step" vertical class="elevation-0">
                    ...
                    <v-stepper-content step="1">
                        ...
                        <v-btn color="primary" :disabled="!contactType" @click="step = step + 1">Continue</v-btn>
                        <v-btn flat to="/clients">Cancel</v-btn>
                    </v-stepper-content>
                    ...
                    <template v-else>
                        ...
                        <v-stepper-content step="3">
                            <v-flex xs12 md8>
                                <v-card class="ma-3 elevation-0">
                                    <v-radio-group class="pl-3" v-model="selectCase" row>
                                                ...
                                                <v-flex xs12 md6 py-0>
                                                    ...
                                                    >
                                                        ...
                                                        <v-date-picker
                                                            ...
                                                            min="1930-01-01"
                                                            @change="saveBirth(caseStartDateNew)"
                                                            :rules="[rules.required]"
                                                        ></v-date-picker>
                                                    </v-menu>
                                                </v-flex>
                            ...
                            <v-btn flat @click="step = step - 1">Previous</v-btn>
                            <v-btn color="primary" :disabled="!selectCase || !valid" @click="step = step + 1">Continue</v-btn>
                            <v-btn color="secundary" @click="step = step + 1; selectCase = null">Skip</v-btn>
                        </v-stepper-content>
                            ...
                            <v-flex xs12 md8 mx-0>
                                ...
                                <v-card class="elevation-0">
                                    <v-card-title class="py-0">
                                        ...
                                        <v-spacer></v-spacer>
                                        <v-btn flat small color="primary">More Fields</v-btn>
                                    </v-card-title>
                                                ...
                                                <v-flex xs6 py-0>
                                                    ...
                                                    >
                                                        ...
                                                        <v-date-picker
                                                            ...
                                                            :max="new Date().toISOString().substr(0, 10)"
                                                            min="1930-01-01"
                                                            @change="saveBirth(birthDate[n], n)"
                                                        ></v-date-picker>
                                                    </v-menu>
                                                </v-flex>
                                                <v-flex xs6 py-0>
                                                    ...
                                                    <v-flex xs6 py-0>
                                                        ...
                                                        >
                                                            ...
                                                            <v-date-picker
                                                                ...
                                                                :max="new Date().toISOString().substr(0, 10)"
                                                                min="1930-01-01"
                                                                @change="saveBirth(caseStartDate[n], n)"
                                                            ></v-date-picker>
                                                        </v-menu>
                                                    </v-flex>
                                                    <v-flex xs6 py-0>
                                                        ...
                                                        >
                                                            ...
                                                            <v-date-picker
                                                                v-model="caseEndDate[n]"
                                                                :min="caseStartDate[n]"
                                                                @change="saveBirth(caseEndDate[n], n)"
                                                            ></v-date-picker>
                                                        </v-menu>
                                                    </v-flex>
                                                </v-layout>
                                                ...
                                                <v-layout>
                                                    <v-flex xs12 py-0>
                                                        <v-autocomplete
                                                            ...
                                                            clearable
                                                            label="Human *" 
                                                            hint="The Human identifier. Points to Human"
                                                            item-text="name"
                                                            item-value="_id"
                                                        >
                                                            <template v-slot:selection="data">
                                                ...
                                                <v-layout>
                                                    <v-flex xs12 py-0>
                                                        <v-autocomplete
                                                            ...
                                                            hint="The Human Relationship type identifier."
                                                            persistent-hint
                                                            item-text="name"
                                                            item-value="_id"
                                                        >
                                                    ...
                                                    <v-flex xs6 py-0>
                                                        ...
                                                        >
                                                            ...
                                                            <v-date-picker
                                                                ...
                                                                :max="new Date().toISOString().substr(0, 10)"
                                                                min="1930-01-01"
                                                                @change="saveBirth(relationshipStartDate[n], n)"
                                                            ></v-date-picker>
                                                        </v-menu>
                                                    </v-flex>
                                                    <v-flex xs6 py-0>
                                                        ...
                                                        >
                                                            ...
                                                            <v-date-picker
                                                                ...
                                                                @change="saveBirth(relationshipEndDate[n], n)"
                                                            ></v-date-picker>
                                                        </v-menu>
                                                    </v-flex>
                                                </v-layout>
                                                    ...
                                                    <v-flex xs6 py-0>
                                                        ...
                                                        >
                                                            ...
                                                            <v-date-picker
                                                                ...
                                                                :max="new Date().toISOString().substr(0, 10)"
                                                                min="1930-01-01"
                                                                @change="saveBirth(groupStartDate[n], n)"
                                                            ></v-date-picker>
                                                        </v-menu>
                                                    </v-flex>
                                                    <v-flex xs6 py-0>
                                                    ...
                                                    <v-flex xs6 py-0>
                                                        ...
                                                        >
                                                            ...
                                                            <v-date-picker
                                                                ...
                                                                :max="new Date().toISOString().substr(0, 10)"
                                                                min="1930-01-01"
                                                                @change="saveBirth(programsStartDate[n], n)"
                                                            ></v-date-picker>
                                                        </v-menu>
                                                    </v-flex>
                                                    <v-flex xs6 py-0>
