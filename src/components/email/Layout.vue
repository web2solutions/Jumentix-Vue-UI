<template>
  <v-app id="mail" class="mail">
    <v-toolbar fixed app flat dark color="primary" clipped-left class="mail-toolbar" id="topbar">
      <v-toolbar-side-icon class="hidden-sm-and-up" @click="toggleDrawer"></v-toolbar-side-icon>
 
      <v-toolbar-title class="ml-0 pl-3">
        <v-btn flat class="hidden-sm-and-down" to="/dashboard">Dashboard / Messages</v-btn>
      </v-toolbar-title>        
      <v-spacer></v-spacer>
      <v-text-field
        flat
