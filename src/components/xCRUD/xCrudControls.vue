<template>
<div>
 <v-toolbar card color="transparent" v-if="displayWhat === 'grid' || displayWhat === 'crud'">
    ...
    <v-tooltip top v-else>
      <v-btn id="xback" fab dark color="blue" @click="bus.$emit('displayWhat', 'grid')" slot="activator">
